...
func (c *Client) EvalRO(ctx context.Context, script string, keys []string, args ...interface{}) *redis.Cmd {
	//TODO implement me
	panic("implement me")
}

func (c *Client) EvalShaRO(ctx context.Context, sha1 string, keys []string, args ...interface{}) *redis.Cmd {
	//TODO implement me
	panic("implement me")
}

func (c *Client) ScriptExists(ctx context.Context, hashes ...string) *redis.BoolSliceCmd {
	//TODO implement me
	panic("implement me")
}
